...
public class sixfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sixfragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //NAVIGATION PAGE 6 à 4
        NavController nvcntrllr = Navigation.findNavController(view);

        Button btn_1 = view.findViewById(R.id.btn_rtr_4);
        btn_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nvcntrllr.navigate(R.id.action_sixfragment_to_fourfragment);
            }
        });
    }
}