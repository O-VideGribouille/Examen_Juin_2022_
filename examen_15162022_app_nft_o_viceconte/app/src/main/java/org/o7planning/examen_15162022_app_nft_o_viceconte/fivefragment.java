...
public class fivefragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fivefragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //NAVIGATION PAGE 5 à 3
        NavController nvcntrllr = Navigation.findNavController(view);

        Button btn_1 = view.findViewById(R.id.btn_rtr_3);
        btn_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nvcntrllr.navigate(R.id.action_fivefragment_to_thirdfragment);
            }
        });
